...
public class DaveCommandGroup extends CommandGroupBase {
     ...
     */
    public DaveCommandGroup(Command... commands) {
    ...
    @Override
    public void execute() {
        if (m_commands.isEmpty() || m_currentCommandIndex < 0 || m_currentCommandIndex >= m_commands.size()) {
            return;
        }
