...
// From YAGSL
/**
 * Clone of WPI SwerveKinematics, which implements second order kinematics when
 * calculating modules states from chassis
 * speed. Makes use of {@link SwerveModuleState2} to add the angular velocity
 * that is required of the module as an
 * output.
 */
public class DaveSwerveKin2 extends SwerveDriveKinematics {
     ...
     */
    private final DaveSwerveModuleState2[] m_moduleStates;
    /**
     * Previous CoR
     */
     ...
     * of wheel locations as Translation2ds.
     * The order in which you pass in the wheel locations is the same order that you
     * will receive the module states when
     * performing inverse kinematics. It is also expected that you pass in the
     * module states in the same order when
     * calling the forward kinematics methods.
     *
     * @param wheelsMeters The locations of the wheels relative to the physical
     *                     center of the robot.
     */
    public DaveSwerveKin2(Translation2d... wheelsMeters) {
        super(wheelsMeters);
        ...
        m_moduleStates = new DaveSwerveModuleState2[m_numModules];
        Arrays.fill(m_moduleStates, new DaveSwerveModuleState2());
    ...
    public static void desaturateWheelSpeeds(
            DaveSwerveModuleState2[] moduleStates, double attainableMaxSpeedMetersPerSecond) {
    ...
    /**
     * Renormalizes the wheel speeds if any individual speed is above the specified
     * maximum, as well as getting rid of
     ...
     * maintaining the ratio of speeds between modules.
     *
     * @param moduleStates                                    Reference to array of
     *                                                        module states. The
     *                                                        array will be
     *                                                        mutated with the
     *                                                        normalized speeds!
     * @param currentChassisSpeed                             The current speed of
     *                                                        the robot
     ...
     */
    public static void desaturateWheelSpeeds(
            DaveSwerveModuleState2[] moduleStates,
        ...
        double rotationalK = Math.abs(currentChassisSpeed.omegaRadiansPerSecond)
     ...
     * chassis velocity. This method is often used
     ...
     * therefore, the argument is defaulted to
     * that use case. However, if you wish to change the center of rotation for
     * evasive maneuvers, vision alignment, or
     ...
     *                               the center of rotation at one corner
     *                               of the robot and provide a chassis speed that
     *                               only has a dtheta component, the robot
     *                               will rotate around that corner.
     * @return An array containing the module states. Use caution because these
     *         module states are not normalized.
     *         Sometimes, a user input may cause one of the module speeds to go
     *         above the attainable max velocity. Use the
     *         {@link #desaturateWheelSpeeds(SwerveModuleState2[], double)
     *         DesaturateWheelSpeeds} function to rectify this issue.
     */
    @SuppressWarnings("PMD.MethodReturnsInternalArray")
    public DaveSwerveModuleState2[] toSwerveModuleStates(
        ...
        for (int i = 0; i < m_numModules; i++) {
            ...
            m_moduleStates[i] = new DaveSwerveModuleState2(speed, angle, omega);
        }
     ...
     */
    public DaveSwerveModuleState2[] toSwerveModuleStates(ChassisSpeeds chassisSpeeds) {
        return toSwerveModuleStates(chassisSpeeds, new Translation2d());
    }

    /**
     * Performs forward kinematics to return the resulting chassis state from the
     * given module states. This method is
     * often used for odometry -- determining the robot's position on the field
     * using data from the real-world speed and
     * angle of each module on the robot.
     *
     * @param wheelStates The state of the modules (as a SwerveModuleState type) as
     *                    measured from respective encoders and
     *                    gyros. The order of the swerve module states should be
     *                    same as passed into the constructor of
     *                    this class.
     * @return The resulting chassis speed.
     */
    public ChassisSpeeds toChassisSpeeds(DaveSwerveModuleState2... wheelStates) {
     ...
     *                    SwerveModulePosition type) as measured from
     *                    respective encoders and gyros. The order of the swerve
     *                    module states should be same as passed
